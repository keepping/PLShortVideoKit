...
/**
 ...
 @since      v1.0.0
 */
- (void)shortVideoSession:(PLShortVideoSession *__nonnull)shortVideoSession didDeleteFileAtURL:(NSURL *__nonnull)fileURL fileDuration:(CGFloat)fileDuration totalDuration:(CGFloat)totalDuration;
...
/**
 ...
 @since      v1.0.0
 */
- (void)shortVideoSession:(PLShortVideoSession *__nonnull)shortVideoSession didFinishRecordingToOutputFileAtURL:(NSURL *__nonnull)fileURL fileDuration:(CGFloat)fileDuration totalDuration:(CGFloat)totalDuration;
...
/**
 @category   PLShortVideoSession (Info)
 @abstract   SDK 信息相关
 
 @since      v1.1.1
 */
@interface PLShortVideoSession (Info)

/*!
 @method     versionInfo
 @abstract   PLShortVideoSession 的 SDK 版本。
